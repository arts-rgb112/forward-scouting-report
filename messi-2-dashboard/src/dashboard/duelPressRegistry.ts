...
export const duelPressMetricConfig: Record<DuelPressMetricKey, MetricPresentation> = {
  ...
  combinedDuel: { label: duelPressAxisLabels.combinedDuel, short: "경합", detail: "지상·공중 경합의 시도량과 승패 마진을 각각 정규화해 균등 결합한 종합 경합 영향력입니다.", formula: "[지상·공중 경합 시도량 50:50] 결합 점수 50%와 [지상·공중 경합 승패 마진/90 50:50] 결합 점수 50%를 동일 문맥 코호트 백분위로 결합합니다." },
  spaceControl: metricConfig.spaceControl,
  forwardPress: { label: duelPressAxisLabels.forwardPress, short: duelPressAxisLabels.forwardPress, detail: "파이널 서드 소유권 획득과 경기 전체의 볼 회수 빈도를 결합한 압박·세컨드볼 회수 지표입니다.", formula: "볼 회수/90 50%와 파이널 서드 소유권 획득/90 50%를 동일 문맥 코호트 백분위로 결합합니다." },
};
