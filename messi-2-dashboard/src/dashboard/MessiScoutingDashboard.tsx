...
export default function MessiScoutingDashboard({
  ...
  return <main id="main-content" aria-busy={isWatchlist ? resolvingWatchlist : refreshing} className="min-h-screen bg-[#080b0c] text-zinc-100"><StatusFeedback message={feedback} /><div className="mx-auto max-w-[1580px] px-3 py-5 sm:px-6 lg:px-8">
