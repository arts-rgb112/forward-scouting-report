...
export type LeaderboardPresentationRow<K extends string, P> = {
  ...
  rank: RankPresentation; tier: Tier | null; tierAccessory?: ReactNode; score: number | null; stats: Partial<Record<K, number>>;
