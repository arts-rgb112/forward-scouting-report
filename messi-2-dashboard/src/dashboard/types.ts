...
export type TacticalQuadrant = { playerId: number; season: string; mode: DatasetMode; scope: 3 | 5 | 7 | null; competition: CompetitionCode | null; available: boolean; reason: "complete" | "axis_metric_missing" | "cohort_unavailable"; source: "messi-static-cohort"; cohortPopulation: number; xAxis: "netProgressionPer90"; yAxis: "inBoxXgotMinusXg"; xMedian: number | null; yMedian: number | null; selectedPoint: TacticalQuadrantPoint | null; points: TacticalQuadrantPoint[] };
