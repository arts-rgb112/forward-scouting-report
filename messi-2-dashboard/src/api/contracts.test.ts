import { describe, expect, it } from "vitest"; import { adaptAnalysis, adaptEnvelope } from "./adapter"; import { parsePlayersEnvelope, playerDetailEnvelopeSchema, playerDtoSchema } from "./contracts";
