...
describe("detail spatial contract", () => {
  ...
  const detail = (spatial: unknown = validSpatial) => ({ data: { ...player, analysis: { score: { value: 50, rank: 5, topPercent: 50, population: 10, archetype: "Type A" }, volumeRadar: { kind: "volume", axes }, ratioRadar: { kind: "ratio", axes }, rawMetrics, spatial } } });
